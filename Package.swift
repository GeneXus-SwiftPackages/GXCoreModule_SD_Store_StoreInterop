...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store_StoreInterop-4.0.8.xcframework.zip",
			checksum: "c1a547b7e1b97d61f68288be5eaefdecf4739b97050e263e9286f0b07ff42292"
		)
	]
)