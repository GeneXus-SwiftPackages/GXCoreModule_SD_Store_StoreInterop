...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-3.1.0-beta.26.xcframework.zip",
			checksum: "986f8ca783776da5b9ceef9edd790008edd826568ea257cb73ce1d38516888b5"
		)
	]
)