...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-2.2.0-beta.18.xcframework.zip",
			checksum: "22c4659ca796092d2340bdbe1d181df5657f4108c733b545f5291568c34ab318"
		)
	]
)