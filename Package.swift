...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-1.3.0-beta.5.xcframework.zip",
			checksum: "6dfc509d1c29205bf386f19c9a2ea0a5b30561010ebe74f5d535257a621043e6"
		)
	]
)