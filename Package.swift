...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-1.3.0-beta.6.xcframework.zip",
			checksum: "17004b6d21e57a081bd09e15e38def811daaf49e9a1197ee2fc2385250817c3e"
		)
	]
)