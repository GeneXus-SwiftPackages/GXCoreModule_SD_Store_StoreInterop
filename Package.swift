...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-1.3.0-beta.4.xcframework.zip",
			checksum: "dc70406b3283044ecd1b7e5538fe6c1eb65bfb495ddd110f254b2fcaed6dd9ef"
		)
	]
)