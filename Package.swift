...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store_StoreInterop-1.3.0-rc.1.xcframework.zip",
			checksum: "472865106b51b6e09bab709ee4b9e458fa3ff743c38fe8d1d531091d09d98ab5"
		)
	]
)