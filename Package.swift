...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-5.0.0-beta.5.xcframework.zip",
			checksum: "722e0d41ec04f31858f8bf6885a113b0a9e3c6915c27a25d73ce4e6f5e4ecf8c"
		)
	]
)