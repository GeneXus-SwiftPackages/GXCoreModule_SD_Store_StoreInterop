...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store_StoreInterop-1.3.6.xcframework.zip",
			checksum: "ce1bafd21f51629abc311ef25e2c6f1349744bf8a84906f14120d4a40c276484"
		)
	]
)