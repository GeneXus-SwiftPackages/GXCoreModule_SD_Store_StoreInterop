...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store_StoreInterop-2.0.0-rc.34.xcframework.zip",
			checksum: "582709306402ac13051484af72d66a3c1cfa08e1ad78a7c570093b2faf0dbcf9"
		)
	]
)