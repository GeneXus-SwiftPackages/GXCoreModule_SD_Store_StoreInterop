...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-1.0.0-beta.20230710193719.xcframework.zip",
			checksum: "b735f8ec3e491c1614fff7bf613a23abdd9aefd6652d948a2309cd46ecf728ac"
		)
	]
)