...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-2.0.0-beta.29.xcframework.zip",
			checksum: "70a1d72c910cab78a961c3f504e8b7c4bc742f8b4e71acac5b70adb4634d5df3"
		)
	]
)