...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-2.2.0-beta.25.xcframework.zip",
			checksum: "3577e5928a5b4ce1585dff8a0fe0a7e2d86f6c2862a86ea412ed33004d94ffda"
		)
	]
)