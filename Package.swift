...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store_StoreInterop-1.2.0.xcframework.zip",
			checksum: "b8d067b2662a810e1f6d987224a88294760a53d67b5362451cb0def52a5a32f1"
		)
	]
)