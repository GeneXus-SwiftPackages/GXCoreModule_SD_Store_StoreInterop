...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-1.0.0-beta+20230306105223.xcframework.zip",
			checksum: "40952e6133e92d8a867f2df9f888d6f6cd8e241739fd264f8ebb9f665e87d25f"
		)
	]
)