...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-1.0.0-beta.20230717155910.xcframework.zip",
			checksum: "200a6018e142735d0abbc7e6a889b7da44d2e3beb1d8fb4405bf92286cdee6df"
		)
	]
)