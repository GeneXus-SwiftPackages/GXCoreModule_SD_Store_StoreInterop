...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-2.2.0-beta.11.xcframework.zip",
			checksum: "3dadb3267b3c9782b1f0230561e80bf3ba3ba546b6cb0b6c9a82b5aaf3d95ec0"
		)
	]
)