...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-2.0.0-beta.31.xcframework.zip",
			checksum: "e01365d3f8fd55382c79a41f3afb1e6da8704df32879aac9358f13fd27ef5568"
		)
	]
)