...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-3.1.0-beta.32.xcframework.zip",
			checksum: "09d7fd035ed444c1c6a6b8826b3a871d09aad790a24df5aab428f61351c075cb"
		)
	]
)