...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-2.0.0-beta.32.xcframework.zip",
			checksum: "5a043c39b141976f511e5b934fbf1bfe8b3299967ab1f83a3e936ed5d8c76b85"
		)
	]
)