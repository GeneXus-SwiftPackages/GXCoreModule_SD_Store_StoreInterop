...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-1.0.0-beta.20230630152236.xcframework.zip",
			checksum: "aac1bc1ce2360307e13f70af55abc04f6f2eea24996e078575ae04abed19851e"
		)
	]
)