...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-1.1.0-beta.8.xcframework.zip",
			checksum: "0c29aadbd9b502a165d6f46cdd35fca89d56250dff604c6828589f0a5606c2ae"
		)
	]
)