...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-1.5.0-beta.26.xcframework.zip",
			checksum: "a768a52890a3aa8d6d330f4cdf708ae36b497e66836a8eaef2fed91fbcb5ea36"
		)
	]
)