...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store_StoreInterop-1.1.0-rc.4.xcframework.zip",
			checksum: "06bf8c4d9d8c7efabfc9cc5e7b693471ee972c06f7ee6b36a0553aa53b32f933"
		)
	]
)