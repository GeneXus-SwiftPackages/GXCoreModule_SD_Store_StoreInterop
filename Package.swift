...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store_StoreInterop-4.0.9.xcframework.zip",
			checksum: "f8d82868dea3387cce6aedcf6728abf5c749fa7055b3c79501c2eb9ae4d7a287"
		)
	]
)