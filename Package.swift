...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store_StoreInterop-3.2.0.xcframework.zip",
			checksum: "56e307be4cfaefb0b56bf9ff2c93d81751215d3f7f228f1f228abbc12af44d05"
		)
	]
)