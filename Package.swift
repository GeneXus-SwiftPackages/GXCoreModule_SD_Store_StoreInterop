...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-1.5.0-beta.27.xcframework.zip",
			checksum: "93e35618cbde22336be36b371cd28e82ce5531288992713838d0bd0aed580149"
		)
	]
)