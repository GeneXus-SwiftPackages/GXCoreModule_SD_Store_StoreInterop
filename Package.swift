...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store_StoreInterop-1.1.0-rc.5.xcframework.zip",
			checksum: "5779491f967d834bfc1e9d179a6c23ae1825a40499f76533e32e3a3e5b5ba2f4"
		)
	]
)