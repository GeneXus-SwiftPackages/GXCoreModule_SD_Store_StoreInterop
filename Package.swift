...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store_StoreInterop-1.2.1.xcframework.zip",
			checksum: "c0decac8a1addd7d454a0dcdc27fa2ac79aa7ddf7d23dad9ba8eed3116157ee6"
		)
	]
)