...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store_StoreInterop-3.0.0-rc.15.xcframework.zip",
			checksum: "9168ab90d9900bc064ee2fc96aabe14dbe40b7d97ef52e2ad2b01660181f5f37"
		)
	]
)