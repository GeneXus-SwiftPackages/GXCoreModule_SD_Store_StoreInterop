...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store_StoreInterop-4.2.0.xcframework.zip",
			checksum: "8f4a4ec2cbf7dd19db4d1e98902bcbc0d2908e401bd0e6b05bc42e27237e4b8c"
		)
	]
)