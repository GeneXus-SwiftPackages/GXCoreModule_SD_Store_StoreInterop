...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-1.4.0-beta.8.xcframework.zip",
			checksum: "202bd2637668bb2adf2c067be867c6de98073e901f88934a5f4a6b17ae5af428"
		)
	]
)