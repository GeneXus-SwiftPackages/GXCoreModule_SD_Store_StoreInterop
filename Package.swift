...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store_StoreInterop-2.0.0-rc.36.xcframework.zip",
			checksum: "020a9bb8846b985df5516943dfa36fbe8b349eba9e48cfbd1d9886dbf402a578"
		)
	]
)