...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-1.2.0-beta.31.xcframework.zip",
			checksum: "ce8a0e8bfbfea29272546b259d17ecba3c6a9ecd2db094d89ea8dbae579c1964"
		)
	]
)