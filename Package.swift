...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-2.0.0-beta.33.xcframework.zip",
			checksum: "1c9a6294d1c45faacbc802476d9ccd1a961f75cd7b663e9d826cff2a6c05ed9c"
		)
	]
)