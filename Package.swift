...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-2.0.0-beta.21.xcframework.zip",
			checksum: "7fdc03c4aebdf9a314dd8701a4920fe92e43e070c808bf31dbf7e85856161f82"
		)
	]
)