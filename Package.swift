...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-1.0.0-beta.20230701000831.xcframework.zip",
			checksum: "b909bda7d7f2c1327d5e728a7891f6b166f99fed01b92b0884b09ef7718475ec"
		)
	]
)