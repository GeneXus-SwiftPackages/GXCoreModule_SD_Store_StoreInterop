...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-1.3.0-beta.11.xcframework.zip",
			checksum: "95ca0926aa2d8b76a68dfb88e3502c359a11d3f48d3444c160420a1cf1dbccad"
		)
	]
)