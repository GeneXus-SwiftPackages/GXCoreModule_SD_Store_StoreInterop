...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-2.0.0-beta.16.xcframework.zip",
			checksum: "f2400780a7de2a254848bbb8ff27aaba1d191d36dcf43323e448ac37e59ca813"
		)
	]
)