...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-3.1.0-beta.11.xcframework.zip",
			checksum: "79087c963cdf3721205bc44a3f3abe0da472b2fb41ab350f038fac59c532326c"
		)
	]
)