...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-4.1.0-beta.22.xcframework.zip",
			checksum: "a22e567a023b13ff9df5f74f634bb9050e9d3e4625782686f0fe75b7c0de7cc7"
		)
	]
)