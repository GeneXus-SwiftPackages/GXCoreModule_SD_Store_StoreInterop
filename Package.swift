...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store_StoreInterop-1.1.0-rc.3.xcframework.zip",
			checksum: "12a805449d3e907da93b7fabf9a682cdfce602fbf2c659c970311b1c492a6e81"
		)
	]
)