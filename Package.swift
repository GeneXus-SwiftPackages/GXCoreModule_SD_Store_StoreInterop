...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_Store_StoreInterop-1.2.2.xcframework.zip",
			checksum: "ffb002c4479fdc5495846f95654709377d8a57188917f657c1a883fa5cb8ae0a"
		)
	]
)