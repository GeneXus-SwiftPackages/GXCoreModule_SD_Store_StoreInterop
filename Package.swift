...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_Store_StoreInterop-1.6.0-rc.0.xcframework.zip",
			checksum: "9df96eb2a37d12a4dde741efbf8a4b38fba6af9a963ddca9ef2a5b4f64b8c21a"
		)
	]
)