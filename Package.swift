...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-4.1.0-beta.13.xcframework.zip",
			checksum: "47a9341f809c15e8214b6c3aa13ac0f8b5706a23639b449398c74c453b5d72f7"
		)
	]
)