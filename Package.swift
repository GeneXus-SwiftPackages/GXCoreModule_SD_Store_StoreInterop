...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_Store_StoreInterop",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_Store_StoreInterop-2.0.0-beta.30.xcframework.zip",
			checksum: "3b0a8205c774feb522d8717a42bded3140a1053d98056b9a85a1e5bb0cb2fb3d"
		)
	]
)